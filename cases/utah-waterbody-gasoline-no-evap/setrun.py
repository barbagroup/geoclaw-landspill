...
def setrun():
    ...
    # for convenience
    break_point = [-12460209.5, 4985137.4]
    ...
    rundata.topo_data.topofiles.append([3, '../common-files/utah-waterbody.asc'])

    # Land-spill module settings
    rundata.landspill_data.ref_mu = 0.6512  # cP @ 15 degree C
    rundata.landspill_data.ref_temperature = 15.
    rundata.landspill_data.ambient_temperature = 25.
    rundata.landspill_data.density = 800.  # kg / m^3 @ 15 degree C; will overwrite rho in GeoClaw
    ...
    rundata.landspill_data.hydro_features.files.append("../common-files/utah-waterbody-hydro.asc")

    # Evaporation
    rundata.landspill_data.evaporation.type = 0
    rundata.landspill_data.evaporation.coefficients = [13.2, 0.21]
