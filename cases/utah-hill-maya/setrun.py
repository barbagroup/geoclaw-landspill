...
def setrun():
    ...
    # for convenience
    break_point = [-12443619., 4977641.]

    # lower and upper edges of computational domain
    rundata.clawdata.lower[0] = break_point[0]-100.
    rundata.clawdata.upper[0] = break_point[0]+700.
    rundata.clawdata.lower[1] = break_point[1]-650
    rundata.clawdata.upper[1] = break_point[1]+150
    ...
    rundata.topo_data.topofiles.append([3, '../common-files/utah-hill.asc'])
    ...
    rundata.landspill_data.hydro_features.files.append("../common-files/utah-hill-hydro.asc")
