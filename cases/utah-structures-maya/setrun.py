...
def setrun():
    ...
    # for convenience
    break_point = [-12458815.605194421, 4987307.342152054]

    # lower and upper edges of computational domain
    rundata.clawdata.lower[0] = break_point[0]-1000.
    rundata.clawdata.upper[0] = break_point[0]+1000.
    rundata.clawdata.lower[1] = break_point[1]-1000
    rundata.clawdata.upper[1] = break_point[1]+1000

    # number of grid cells: coarsest grid
    rundata.clawdata.num_cells[0] = 500
    rundata.clawdata.num_cells[1] = 500
    ...
    rundata.topo_data.topofiles.append([3, '../common-files/utah-structures.asc'])
    ...
    rundata.landspill_data.hydro_features.files.append("../common-files/utah-structures-hydro.asc")
