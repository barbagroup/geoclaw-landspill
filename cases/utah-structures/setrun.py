...
def setrun(claw_pkg: str = 'geoclaw'):
    ...
    clawdata.lower[0] = -12458815.605194421-1000.0
    clawdata.upper[0] = -12458815.605194421+1000.0
    clawdata.lower[1] = 4987307.342152054-1000.0
    clawdata.upper[1] = 4987307.342152054+1000.0

    # number of grid cells: coarsest grid
    clawdata.num_cells[0] = 500
    clawdata.num_cells[1] = 500
...
def setgeo(rundata: data.ClawRunData):
    ...
    topo_data.topofiles.append([3, "../common-files/utah-structure.asc"])
    ...
    ptsources_data.point_sources.append(
        [[-12458815.605194421, 4987307.342152054], 2, [ 1800., 12600.], [0.5, 0.1]])
    ...
    hydro_feature_data.files.append("../common-files/utah-structure-hydro.asc")
