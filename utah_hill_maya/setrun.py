...
#------------------------------
    ...
    clawdata.lower[0] = -12443619.-400.
    clawdata.upper[0] = -12443619.+400.

    clawdata.lower[1] = 4977614.-400
    clawdata.upper[1] = 4977614.+400
...
#-------------------
    ...
    topo_data.topofiles.append([3, 1, 5, 0., 1.e10, 'mountain.asc'])
    ...
    # hydro_feature_data.files.append("./test.txt.asc")
